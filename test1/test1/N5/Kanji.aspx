<%@ Page Title="" Language="C#" MasterPageFile="~/N5/N5.Master" AutoEventWireup="true" CodeBehind="Kanji.aspx.cs" Inherits="test1.N5.Kanji" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder2">
    ...
    <div class="text-justify" style="text-align: center; margin-left:20%" align="center">
        <div class="text-justify" style="text-align: center; margin-left:10%" align="center">
    ...
    <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" DataKeyNames="KanjiID" DataSourceID="SqlDataSource1" style="margin-left: 0px">
    <Columns>
        ...
        <asp:BoundField DataField="HanTu" HeaderText="Hán tự" SortExpression="HanTu" />
        <asp:BoundField DataField="Bai" HeaderText="Bai" SortExpression="Bai" Visible="False" />
    </Columns>
</asp:GridView>
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:con %>" SelectCommand="SELECT * FROM [Kanji] WHERE ([Bai] = @Bai)">
    <SelectParameters>
        <asp:QueryStringParameter Name="Bai" QueryStringField="Bai" Type="Int32" />
    </SelectParameters>
</asp:SqlDataSource>
