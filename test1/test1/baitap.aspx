<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="baitap.aspx.cs" Inherits="test1.WebForm3" %>
                    ...
                    <nav class="navbar navbar-light navbar-glass navbar-top sticky-kit navbar-expand-lg" style="width: 1349px;">
                        ...
                        <div class="collapse navbar-collapse" id="navbarStandard">
                            <ul class="navbar-nav hover">
                                ...
                                <li class="nav-item"><a class="nav-link text-uppercase " href="./viet_nhat.aspx">Nhật - VIệt</a> </li>
        ...
        <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <div class="navbar-vertical-content perfect-scrollbar scrollbar">
                            ...
                            <a class="nav-link">
                                <div class="d-flex align-items-center">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Bai" DataSourceID="SqlDataSource1">
                                        <Columns>
                                            <asp:BoundField DataField="Bai" HeaderText="Bai" InsertVisible="False" ReadOnly="True" SortExpression="Bai" Visible="False" />
                                            <asp:BoundField DataField="Tenbai" HeaderText="Tenbai" SortExpression="Tenbai" Visible="False" />
                                            <asp:HyperLinkField DataNavigateUrlFields="Bai" DataNavigateUrlFormatString="~/N5/tuvung.aspx?bai={0}" DataTextField="Tenbai" HeaderText="Từ vựng"></asp:HyperLinkField>
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link">
                                <div class="d-flex align-items-center">
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="Bai" DataSourceID="SqlDataSource1">
                                        <Columns>
                                            <asp:BoundField DataField="Bai" HeaderText="Bai" InsertVisible="False" ReadOnly="True" SortExpression="Bai" Visible="False" />
                                            <asp:BoundField DataField="Tenbai" HeaderText="Tenbai" SortExpression="Tenbai" Visible="False" />
                                            <asp:HyperLinkField DataNavigateUrlFields="Bai" DataNavigateUrlFormatString="~/N5/nguphap.aspx?bai={0}" DataTextField="Tenbai" HeaderText="Ngữ pháp"></asp:HyperLinkField>
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link">
                                <div class="d-flex align-items-center">
                                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataKeyNames="Bai" DataSourceID="SqlDataSource1">
                                        <Columns>
                                            <asp:BoundField DataField="Bai" HeaderText="Bai" InsertVisible="False" ReadOnly="True" SortExpression="Bai" Visible="False" />
                                            <asp:BoundField DataField="Tenbai" HeaderText="Tenbai" SortExpression="Tenbai" Visible="False" />
                                            <asp:HyperLinkField DataNavigateUrlFields="Bai" DataNavigateUrlFormatString="~/N5/Kanji.aspx?bai={0}" DataTextField="Tenbai" HeaderText="Kanji"></asp:HyperLinkField>
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </a>
                  ...
                  <div class="navbar-vertical-divider">
                        ...
                        <li class="nav-item">
                            <a class="nav-link">
                                <div class="d-flex align-items-center">
                                     <div class="d-flex align-items-center">
                                    <asp:HyperLink ID="HyperLink1" runat="server"><a href="../baitap.aspx">Bài tập</a></asp:HyperLink>
                                </div>
                                </div>
                            </a>
                            <ul class="nav">
...
<b><asp:Label ID="Label1" runat="server" Text="Câu "></asp:Label><%#Container.ItemIndex+1 %><asp:Label ID="Label6" runat="server" Text=": "></asp:Label></b>
<asp:Label ID="cauhoi" runat="server"  Text='<%# Eval("cauhoi") %>'></asp:Label>
        
        <asp:Label Text='<%#Eval("Cauhoi")%>'></asp:Label>
        <br />
        <asp:RadioButton GroupName="quiz" ID="RadioButton1" runat="server" Text='<%#Eval("CauA")%>'/>
        <br />
        <asp:RadioButton GroupName="quiz" ID="RadioButton2" runat="server" Text='<%#Eval("CauB")%>'/>
        <br />
        <asp:RadioButton GroupName="quiz" ID="RadioButton3" runat="server" Text='<%#Eval("CauC")%>'/>
        <br />
        <asp:RadioButton GroupName="quiz" ID="RadioButton4" runat="server" Text='<%#Eval("CauD")%>'/>
     

        <br />                   
       <asp:Label ID="labcorrectans" runat="server"  Text='<%# Eval("DapAn") %>' Visible="false"></asp:Label>
        <br />
        <asp:Label ID="labuserselectoption" runat="server" Text=" "></asp:Label>    
    </ItemTemplate>
        </asp:Repeater>
      <asp:Button ID="btnnop" runat="server" Text="Nộp bài" OnClick="btnnop_Click" />

<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:con %>" SelectCommand="SELECT * FROM [Test]">
</asp:SqlDataSource>
